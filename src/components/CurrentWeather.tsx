  ...
  return (
    <div className="current-weather-wrap">
      ...
      <section className="left-column">
        ...
        <div className="hero">
          {props.temperature} <span className="text-secondary">&#176;{unit}</span>
        </div>
      </section>
      <section className="right-column text-center text-sm-left">
        <div>
          <span className="text-secondary">Precipitation:</span> {props.precipitation}
        </div>
        <div>
          <span className="text-secondary">Humidity:</span> {props.humidity}
        </div>
        <div>
          <span className="text-secondary">Wind:</span> {props.wind}
        </div>
        <div>
          <span className="text-secondary">Clouds:</span> {props.clouds}
        </div>
      </section>
    </div>
  );
